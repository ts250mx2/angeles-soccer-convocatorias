    ...
    try {
        ...
        const data = (baseRows as any[]).map((r: any) => {
            ...
            return {
                ...
                ActualKeepersSinPagos: a.keepersSinPagos,
                ActualKeepersBecadosSinPagos: a.keepersBecadosSinPagos,
                ...
                AnteriorKeepersSinPagos: p.keepersSinPagos,
                AnteriorKeepersBecadosSinPagos: p.keepersBecadosSinPagos,
